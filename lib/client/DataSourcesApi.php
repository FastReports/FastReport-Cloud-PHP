...
class DataSourcesApi
{
    ...
    /**
     * Operation dataSourcesGetMyPermissions
     *
     * Get current user&#39;s permissions to Data source
     *
     * @param  string $id data source id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSourcesGetMyPermissions'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails
     */
    public function dataSourcesGetMyPermissions($id, string $contentType = self::contentTypes['dataSourcesGetMyPermissions'][0])
    {
        list($response) = $this->dataSourcesGetMyPermissionsWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation dataSourcesGetMyPermissionsWithHttpInfo
     *
     * Get current user&#39;s permissions to Data source
     *
     * @param  string $id data source id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function dataSourcesGetMyPermissionsWithHttpInfo($id, string $contentType = self::contentTypes['dataSourcesGetMyPermissions'][0])
    {
        $request = $this->dataSourcesGetMyPermissionsRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation dataSourcesGetMyPermissionsAsync
     *
     * Get current user&#39;s permissions to Data source
     *
     * @param  string $id data source id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSourcesGetMyPermissionsAsync($id, string $contentType = self::contentTypes['dataSourcesGetMyPermissions'][0])
    {
        return $this->dataSourcesGetMyPermissionsAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dataSourcesGetMyPermissionsAsyncWithHttpInfo
     *
     * Get current user&#39;s permissions to Data source
     *
     * @param  string $id data source id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSourcesGetMyPermissionsAsyncWithHttpInfo($id, string $contentType = self::contentTypes['dataSourcesGetMyPermissions'][0])
    {
        $returnType = '\OpenAPI\Client\cloud\fastreport\model\DataSourcePermissionCRUDVM';
        $request = $this->dataSourcesGetMyPermissionsRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'dataSourcesGetMyPermissions'
     *
     * @param  string $id data source id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSourcesGetMyPermissions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function dataSourcesGetMyPermissionsRequest($id, string $contentType = self::contentTypes['dataSourcesGetMyPermissions'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling dataSourcesGetMyPermissions'
            );
        }
        if (!preg_match("/^[A-Fa-f0-9]{24}$/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling DataSourcesApi.dataSourcesGetMyPermissions, must conform to the pattern /^[A-Fa-f0-9]{24}$/.");
        }
        

        $resourcePath = '/api/data/v1/DataSources/{id}/mypermissions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation dataSourcesGetParameterTypes
     *
     * Get data source parameter DataType&#39;s
     *
     * @param  DataSourceConnectionType $data_source_type data source type (MsSql, MySql, etc.) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSourcesGetParameterTypes'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\cloud\fastreport\model\DataSourceParameterTypesVM|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails
     */
    public function dataSourcesGetParameterTypes($data_source_type, string $contentType = self::contentTypes['dataSourcesGetParameterTypes'][0])
    {
        list($response) = $this->dataSourcesGetParameterTypesWithHttpInfo($data_source_type, $contentType);
        return $response;
    }

    /**
     * Operation dataSourcesGetParameterTypesWithHttpInfo
     *
     * Get data source parameter DataType&#39;s
     *
     * @param  DataSourceConnectionType $data_source_type data source type (MsSql, MySql, etc.) (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\cloud\fastreport\model\DataSourceParameterTypesVM|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function dataSourcesGetParameterTypesWithHttpInfo($data_source_type, string $contentType = self::contentTypes['dataSourcesGetParameterTypes'][0])
    {
        $request = $this->dataSourcesGetParameterTypesRequest($data_source_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\cloud\fastreport\model\DataSourceParameterTypesVM' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\cloud\fastreport\model\DataSourceParameterTypesVM' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\cloud\fastreport\model\DataSourceParameterTypesVM', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\cloud\fastreport\model\DataSourceParameterTypesVM';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation dataSourcesGetParameterTypesAsync
     *
     * Get data source parameter DataType&#39;s
     *
     * @param  DataSourceConnectionType $data_source_type data source type (MsSql, MySql, etc.) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSourcesGetParameterTypesAsync($data_source_type, string $contentType = self::contentTypes['dataSourcesGetParameterTypes'][0])
    {
        return $this->dataSourcesGetParameterTypesAsyncWithHttpInfo($data_source_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dataSourcesGetParameterTypesAsyncWithHttpInfo
     *
     * Get data source parameter DataType&#39;s
     *
     * @param  DataSourceConnectionType $data_source_type data source type (MsSql, MySql, etc.) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSourcesGetParameterTypesAsyncWithHttpInfo($data_source_type, string $contentType = self::contentTypes['dataSourcesGetParameterTypes'][0])
    {
        $returnType = '\OpenAPI\Client\cloud\fastreport\model\DataSourceParameterTypesVM';
        $request = $this->dataSourcesGetParameterTypesRequest($data_source_type, $contentType);
    ...
    /**
     * Create request for operation 'dataSourcesGetParameterTypes'
     *
     * @param  DataSourceConnectionType $data_source_type data source type (MsSql, MySql, etc.) (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSourcesGetParameterTypes'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function dataSourcesGetParameterTypesRequest($data_source_type, string $contentType = self::contentTypes['dataSourcesGetParameterTypes'][0])
    {

        // verify the required parameter 'data_source_type' is set
        if ($data_source_type === null || (is_array($data_source_type) && count($data_source_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data_source_type when calling dataSourcesGetParameterTypes'
            );
        }


        $resourcePath = '/api/data/v1/DataSources/parameterTypes/{dataSourceType}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($data_source_type !== null) {
            $resourcePath = str_replace(
                '{' . 'dataSourceType' . '}',
                ObjectSerializer::toPathValue($data_source_type),
                $resourcePath
            );
        }
    ...
    /**
     * Operation dataSourcesUpdateSelectCommands
     *
     * Update data source&#39;s select commands by id
     *
     * @param  string $id data source id (required)
     * @param  \OpenAPI\Client\cloud\fastreport\model\UpdateDataSourceSelectCommandsVM $update_data_source_select_commands_vm update viewmodel (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSourcesUpdateSelectCommands'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\cloud\fastreport\model\DataSourceVM|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails
     */
    public function dataSourcesUpdateSelectCommands($id, $update_data_source_select_commands_vm = null, string $contentType = self::contentTypes['dataSourcesUpdateSelectCommands'][0])
    {
        list($response) = $this->dataSourcesUpdateSelectCommandsWithHttpInfo($id, $update_data_source_select_commands_vm, $contentType);
        return $response;
    }

    /**
     * Operation dataSourcesUpdateSelectCommandsWithHttpInfo
     *
     * Update data source&#39;s select commands by id
     *
     * @param  string $id data source id (required)
     ...
     * @return array of \OpenAPI\Client\cloud\fastreport\model\DataSourceVM|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails|\OpenAPI\Client\cloud\fastreport\model\ProblemDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function dataSourcesUpdateSelectCommandsWithHttpInfo($id, $update_data_source_select_commands_vm = null, string $contentType = self::contentTypes['dataSourcesUpdateSelectCommands'][0])
    {
        $request = $this->dataSourcesUpdateSelectCommandsRequest($id, $update_data_source_select_commands_vm, $contentType);
    ...
    /**
     * Operation dataSourcesUpdateSelectCommandsAsync
     *
     * Update data source&#39;s select commands by id
     *
     * @param  string $id data source id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSourcesUpdateSelectCommandsAsync($id, $update_data_source_select_commands_vm = null, string $contentType = self::contentTypes['dataSourcesUpdateSelectCommands'][0])
    {
        return $this->dataSourcesUpdateSelectCommandsAsyncWithHttpInfo($id, $update_data_source_select_commands_vm, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dataSourcesUpdateSelectCommandsAsyncWithHttpInfo
     *
     * Update data source&#39;s select commands by id
     *
     * @param  string $id data source id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataSourcesUpdateSelectCommandsAsyncWithHttpInfo($id, $update_data_source_select_commands_vm = null, string $contentType = self::contentTypes['dataSourcesUpdateSelectCommands'][0])
    {
        $returnType = '\OpenAPI\Client\cloud\fastreport\model\DataSourceVM';
        $request = $this->dataSourcesUpdateSelectCommandsRequest($id, $update_data_source_select_commands_vm, $contentType);
    ...
    /**
     * Create request for operation 'dataSourcesUpdateSelectCommands'
     *
     * @param  string $id data source id (required)
     * @param  \OpenAPI\Client\cloud\fastreport\model\UpdateDataSourceSelectCommandsVM $update_data_source_select_commands_vm update viewmodel (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dataSourcesUpdateSelectCommands'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function dataSourcesUpdateSelectCommandsRequest($id, $update_data_source_select_commands_vm = null, string $contentType = self::contentTypes['dataSourcesUpdateSelectCommands'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling dataSourcesUpdateSelectCommands'
            );
        }
        if (!preg_match("/^[A-Fa-f0-9]{24}$/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling DataSourcesApi.dataSourcesUpdateSelectCommands, must conform to the pattern /^[A-Fa-f0-9]{24}$/.");
        }
        


        $resourcePath = '/api/data/v1/DataSources/{id}/selectCommands';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($update_data_source_select_commands_vm)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_data_source_select_commands_vm));
            } else {
                $httpBody = $update_data_source_select_commands_vm;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
