 ...
 */
class AdminFolderCreateVM extends FolderCreateVM
{
    ...
    */
    ...
    public function setParentId($parent_id)
    {
        ...
        if ((mb_strlen($parent_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parent_id when calling AdminFolderCreateVM., must be bigger than or equal to 1.');
        }
    ...
    public function setOwnerId($owner_id)
    {
        ...
        if ((mb_strlen($owner_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $owner_id when calling AdminFolderCreateVM., must be bigger than or equal to 1.');
        }
