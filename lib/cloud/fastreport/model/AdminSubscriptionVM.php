 ...
 */
class AdminSubscriptionVM extends SubscriptionVM
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['owner_id']) && !preg_match("/^[A-Fa-f0-9]{24}$/", $this->container['owner_id'])) {
            $invalidProperties[] = "invalid value for 'owner_id', must be conform to the pattern /^[A-Fa-f0-9]{24}$/.";
        }
    ...
    public function setOwnerId($owner_id)
    {
        ...
        if (!is_null($owner_id) && (!preg_match("/^[A-Fa-f0-9]{24}$/", ObjectSerializer::toString($owner_id)))) {
            throw new \InvalidArgumentException("invalid value for \$owner_id when calling AdminSubscriptionVM., must conform to the pattern /^[A-Fa-f0-9]{24}$/.");
        }
