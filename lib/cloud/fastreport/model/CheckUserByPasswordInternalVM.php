...
/**
 * CheckUserByPasswordInternalVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CheckUserByPasswordInternalVM extends CloudBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckUserByPasswordInternalVM';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 250)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CheckUserByPasswordInternalVM., must be smaller than or equal to 250.');
        }
        if (!is_null($email) && (mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CheckUserByPasswordInternalVM., must be bigger than or equal to 0.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if (!is_null($password) && (mb_strlen($password) > 50)) {
            throw new \InvalidArgumentException('invalid length for $password when calling CheckUserByPasswordInternalVM., must be smaller than or equal to 50.');
        }
        if (!is_null($password) && (mb_strlen($password) < 0)) {
            throw new \InvalidArgumentException('invalid length for $password when calling CheckUserByPasswordInternalVM., must be bigger than or equal to 0.');
        }
