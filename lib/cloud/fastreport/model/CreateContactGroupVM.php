...
/**
 * CreateContactGroupVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateContactGroupVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateContactGroupVM';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateContactGroupVM., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        ...
        if (!is_null($subscription_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", ObjectSerializer::toString($subscription_id)))) {
            throw new \InvalidArgumentException("invalid value for \$subscription_id when calling CreateContactGroupVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
