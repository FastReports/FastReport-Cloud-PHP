 ...
 */
class CreateDataSourceAdminVM extends CreateDataSourceVM
{
    ...
    */
    ...
    public function setOwnerId($owner_id)
    {
        ...
        if ((mb_strlen($owner_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $owner_id when calling CreateDataSourceAdminVM., must be bigger than or equal to 1.');
        }
