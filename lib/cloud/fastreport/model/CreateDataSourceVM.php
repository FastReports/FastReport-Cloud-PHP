 ...
 */
class CreateDataSourceVM extends CloudBaseVM
{
    ...
    */
    ...
    public function setSelectCommands($select_commands)
    {
        ...
        if (!is_null($select_commands) && (count($select_commands) > 10)) {
            throw new \InvalidArgumentException('invalid value for $select_commands when calling CreateDataSourceVM., number of items must be less than or equal to 10.');
        }
