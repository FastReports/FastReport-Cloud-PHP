...
/**
 * CreateEmailTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateEmailTaskVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateEmailTaskVM';
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 300)) {
            throw new \InvalidArgumentException('invalid length for $password when calling CreateEmailTaskVM., must be smaller than or equal to 300.');
        }
        if (!is_null($password) && (mb_strlen($password) < 5)) {
            throw new \InvalidArgumentException('invalid length for $password when calling CreateEmailTaskVM., must be bigger than or equal to 5.');
        }
    ...
    public function setBody($body)
    {
        if (!is_null($body) && (mb_strlen($body) > 384000)) {
            throw new \InvalidArgumentException('invalid length for $body when calling CreateEmailTaskVM., must be smaller than or equal to 384000.');
        }
        if (!is_null($body) && (mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling CreateEmailTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setSubject($subject)
    {
        if (!is_null($subject) && (mb_strlen($subject) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling CreateEmailTaskVM., must be smaller than or equal to 1000.');
        }
        if (!is_null($subject) && (mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling CreateEmailTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setTo($to)
    {
        ...
        if (!is_null($to) && (count($to) > 200)) {
            throw new \InvalidArgumentException('invalid value for $to when calling CreateEmailTaskVM., number of items must be less than or equal to 200.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 100)) {
            throw new \InvalidArgumentException('invalid length for $username when calling CreateEmailTaskVM., must be smaller than or equal to 100.');
        }
        if (!is_null($username) && (mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling CreateEmailTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setServer($server)
    {
        if (!is_null($server) && (mb_strlen($server) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $server when calling CreateEmailTaskVM., must be smaller than or equal to 5000.');
        }
        if (!is_null($server) && (mb_strlen($server) < 1)) {
            throw new \InvalidArgumentException('invalid length for $server when calling CreateEmailTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $port when calling CreateEmailTaskVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($port) && ($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling CreateEmailTaskVM., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateEmailTaskVM., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateEmailTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        ...
        if (!is_null($subscription_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling CreateEmailTaskVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
