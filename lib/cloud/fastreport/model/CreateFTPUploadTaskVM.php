...
/**
 * CreateFTPUploadTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateFTPUploadTaskVM extends CreateTransportTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateFTPUploadTaskVM';
    ...
    */
    ...
    public function setFtpHost($ftp_host)
    {
        ...
        if (!is_null($ftp_host) && (mb_strlen($ftp_host) > 400)) {
            throw new \InvalidArgumentException('invalid length for $ftp_host when calling CreateFTPUploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($ftp_host) && (mb_strlen($ftp_host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_host when calling CreateFTPUploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setFtpPassword($ftp_password)
    {
        ...
        if (!is_null($ftp_password) && (mb_strlen($ftp_password) > 300)) {
            throw new \InvalidArgumentException('invalid length for $ftp_password when calling CreateFTPUploadTaskVM., must be smaller than or equal to 300.');
        }
        if (!is_null($ftp_password) && (mb_strlen($ftp_password) < 4)) {
            throw new \InvalidArgumentException('invalid length for $ftp_password when calling CreateFTPUploadTaskVM., must be bigger than or equal to 4.');
        }
    ...
    public function setFtpUsername($ftp_username)
    {
        ...
        if (!is_null($ftp_username) && (mb_strlen($ftp_username) > 300)) {
            throw new \InvalidArgumentException('invalid length for $ftp_username when calling CreateFTPUploadTaskVM., must be smaller than or equal to 300.');
        }
        if (!is_null($ftp_username) && (mb_strlen($ftp_username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_username when calling CreateFTPUploadTaskVM., must be bigger than or equal to 1.');
        }
