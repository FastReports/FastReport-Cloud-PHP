...
/**
 * CreateS3UploadTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateS3UploadTaskVM extends CreateTransportTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateS3UploadTaskVM';
    ...
    */
    ...
    public function setAccessKey($access_key)
    {
        ...
        if (!is_null($access_key) && (mb_strlen($access_key) > 400)) {
            throw new \InvalidArgumentException('invalid length for $access_key when calling CreateS3UploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($access_key) && (mb_strlen($access_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $access_key when calling CreateS3UploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setSecretKey($secret_key)
    {
        ...
        if (!is_null($secret_key) && (mb_strlen($secret_key) > 400)) {
            throw new \InvalidArgumentException('invalid length for $secret_key when calling CreateS3UploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($secret_key) && (mb_strlen($secret_key) < 4)) {
            throw new \InvalidArgumentException('invalid length for $secret_key when calling CreateS3UploadTaskVM., must be bigger than or equal to 4.');
        }
    ...
    public function setBucketName($bucket_name)
    {
        ...
        if (!is_null($bucket_name) && (mb_strlen($bucket_name) > 400)) {
            throw new \InvalidArgumentException('invalid length for $bucket_name when calling CreateS3UploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($bucket_name) && (mb_strlen($bucket_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bucket_name when calling CreateS3UploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setDestinationFolder($destination_folder)
    {
        ...
        if (!is_null($destination_folder) && (mb_strlen($destination_folder) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $destination_folder when calling CreateS3UploadTaskVM., must be smaller than or equal to 5000.');
        }
        if (!is_null($destination_folder) && (mb_strlen($destination_folder) < 0)) {
            throw new \InvalidArgumentException('invalid length for $destination_folder when calling CreateS3UploadTaskVM., must be bigger than or equal to 0.');
        }
    ...
    {
        if (is_null($use_aws)) {
            throw new \InvalidArgumentException('non-nullable use_aws cannot be null');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 20)) {
            throw new \InvalidArgumentException('invalid length for $region when calling CreateS3UploadTaskVM., must be smaller than or equal to 20.');
        }
        if (!is_null($region) && (mb_strlen($region) < 0)) {
            throw new \InvalidArgumentException('invalid length for $region when calling CreateS3UploadTaskVM., must be bigger than or equal to 0.');
        }
