...
/**
 * CreateSubscriptionPlanVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSubscriptionPlanVM extends CloudBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSubscriptionPlanVM';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fonts_space_limit']) && ($this->container['fonts_space_limit'] < 0)) {
            $invalidProperties[] = "invalid value for 'fonts_space_limit', must be bigger than or equal to 0.";
        }
    ...
    public function setDisplayName($display_name)
    {
        ...
        if (!is_null($display_name) && (mb_strlen($display_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CreateSubscriptionPlanVM., must be smaller than or equal to 50.');
        }
        if (!is_null($display_name) && (mb_strlen($display_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CreateSubscriptionPlanVM., must be bigger than or equal to 1.');
        }
    ...
    public function setTimePeriod($time_period)
    {
        ...
        if (!is_null($time_period) && ($time_period > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $time_period when calling CreateSubscriptionPlanVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($time_period) && ($time_period < 1)) {
            throw new \InvalidArgumentException('invalid value for $time_period when calling CreateSubscriptionPlanVM., must be bigger than or equal to 1.');
        }
    ...
    public function setTemplatesSpaceLimit($templates_space_limit)
    {
        ...
        if (!is_null($templates_space_limit) && ($templates_space_limit < 1048576)) {
            throw new \InvalidArgumentException('invalid value for $templates_space_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 1048576.');
        }
    ...
    public function setReportsSpaceLimit($reports_space_limit)
    {
        ...
        if (!is_null($reports_space_limit) && ($reports_space_limit < 1048576)) {
            throw new \InvalidArgumentException('invalid value for $reports_space_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 1048576.');
        }
    ...
    public function setExportsSpaceLimit($exports_space_limit)
    {
        ...
        if (!is_null($exports_space_limit) && ($exports_space_limit < 1048576)) {
            throw new \InvalidArgumentException('invalid value for $exports_space_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 1048576.');
        }
    ...
    public function setFontsSpaceLimit($fonts_space_limit)
    {
        ...
        if (!is_null($fonts_space_limit) && ($fonts_space_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $fonts_space_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 0.');
        }
    ...
    public function setFileUploadSizeLimit($file_upload_size_limit)
    {
        ...
        if (!is_null($file_upload_size_limit) && ($file_upload_size_limit > 1073741824)) {
            throw new \InvalidArgumentException('invalid value for $file_upload_size_limit when calling CreateSubscriptionPlanVM., must be smaller than or equal to 1073741824.');
        }
        if (!is_null($file_upload_size_limit) && ($file_upload_size_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $file_upload_size_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 0.');
        }
    ...
    public function setDataSourceLimit($data_source_limit)
    {
        ...
        if (!is_null($data_source_limit) && ($data_source_limit > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $data_source_limit when calling CreateSubscriptionPlanVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($data_source_limit) && ($data_source_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $data_source_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxUsersCount($max_users_count)
    {
        ...
        if (!is_null($max_users_count) && ($max_users_count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $max_users_count when calling CreateSubscriptionPlanVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($max_users_count) && ($max_users_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_users_count when calling CreateSubscriptionPlanVM., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupLimit($group_limit)
    {
        ...
        if (!is_null($group_limit) && ($group_limit > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $group_limit when calling CreateSubscriptionPlanVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($group_limit) && ($group_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $group_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 0.');
        }
    ...
    public function setUrlToBuy($url_to_buy)
    {
        ...
        if (!is_null($url_to_buy) && (mb_strlen($url_to_buy) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $url_to_buy when calling CreateSubscriptionPlanVM., must be smaller than or equal to 1000.');
        }
        if (!is_null($url_to_buy) && (mb_strlen($url_to_buy) < 0)) {
            throw new \InvalidArgumentException('invalid length for $url_to_buy when calling CreateSubscriptionPlanVM., must be bigger than or equal to 0.');
        }
    ...
    public function setPageLimit($page_limit)
    {
        ...
        if (!is_null($page_limit) && ($page_limit > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $page_limit when calling CreateSubscriptionPlanVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($page_limit) && ($page_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 0.');
        }
    ...
    public function setReadonlyTimeLimit($readonly_time_limit)
    {
        ...
        if (!is_null($readonly_time_limit) && ($readonly_time_limit > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $readonly_time_limit when calling CreateSubscriptionPlanVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($readonly_time_limit) && ($readonly_time_limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $readonly_time_limit when calling CreateSubscriptionPlanVM., must be bigger than or equal to 1.');
        }
