...
/**
 * CreateTaskEndVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class CreateTaskEndVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTaskEndVM';
    ...
    */
    ...
    public function setAfter($after)
    {
        ...
        if (!is_null($after) && ($after > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $after when calling CreateTaskEndVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($after) && ($after < 0)) {
            throw new \InvalidArgumentException('invalid value for $after when calling CreateTaskEndVM., must be bigger than or equal to 0.');
        }
    ...
    {
        if (is_null($on)) {
            array_push($this->openAPINullablesSetToNull, 'on');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('on', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
