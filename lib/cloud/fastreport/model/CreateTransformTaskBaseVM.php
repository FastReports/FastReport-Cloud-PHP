...
/**
 * CreateTransformTaskBaseVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTransformTaskBaseVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTransformTaskBaseVM';
    ...
    protected static $openAPITypes = [
        'locale' => 'string',
        'input_file' => '\OpenAPI\Client\cloud\fastreport\model\InputFileVM',
        'output_file' => '\OpenAPI\Client\cloud\fastreport\model\OutputFileVM',
        'transports' => '\OpenAPI\Client\cloud\fastreport\model\CreateTransportTaskBaseVM[]',
        'name' => 'string',
    ...
    public function setLocale($locale)
    {
        ...
        if (!is_null($locale) && (!preg_match("/^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/", $locale))) {
            throw new \InvalidArgumentException("invalid value for $locale when calling CreateTransformTaskBaseVM., must conform to the pattern /^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/.");
        }
     ...
     * Gets input_file
     *
     * @return \OpenAPI\Client\cloud\fastreport\model\InputFileVM|null
     */
     ...
     * Sets input_file
     *
     * @param \OpenAPI\Client\cloud\fastreport\model\InputFileVM|null $input_file input_file
     *
     * @return self
     */
     ...
     * Gets transports
     *
     * @return \OpenAPI\Client\cloud\fastreport\model\CreateTransportTaskBaseVM[]|null
     */
     ...
     * Sets transports
     *
     * @param \OpenAPI\Client\cloud\fastreport\model\CreateTransportTaskBaseVM[]|null $transports transports
     *
     * @return self
     */
    public function setTransports($transports)
    {
        ...
        if (!is_null($transports) && (count($transports) > 10)) {
            throw new \InvalidArgumentException('invalid value for $transports when calling CreateTransformTaskBaseVM., number of items must be less than or equal to 10.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateTransformTaskBaseVM., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateTransformTaskBaseVM., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        ...
        if (!is_null($subscription_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling CreateTransformTaskBaseVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
