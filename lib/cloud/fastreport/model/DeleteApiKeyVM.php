...
/**
 * DeleteApiKeyVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeleteApiKeyVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteApiKeyVM';
    ...
    */
    ...
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling DeleteApiKeyVM., must be bigger than or equal to 1.');
        }
