...
/**
 * ExportTemplateVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExportTemplateVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportTemplateVM';
    ...
    public function setFileName($file_name)
    {
        if (!is_null($file_name) && (mb_strlen($file_name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling ExportTemplateVM., must be smaller than or equal to 250.');
        }
        if (!is_null($file_name) && (mb_strlen($file_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling ExportTemplateVM., must be bigger than or equal to 0.');
        }
    ...
    public function setFolderId($folder_id)
    {
        ...
        if (!is_null($folder_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", $folder_id))) {
            throw new \InvalidArgumentException("invalid value for $folder_id when calling ExportTemplateVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
    ...
    public function setLocale($locale)
    {
        ...
        if (!is_null($locale) && (!preg_match("/^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/", $locale))) {
            throw new \InvalidArgumentException("invalid value for $locale when calling ExportTemplateVM., must conform to the pattern /^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/.");
        }
    ...
    public function setPagesCount($pages_count)
    {
        ...
        if (!is_null($pages_count) && ($pages_count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling ExportTemplateVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($pages_count) && ($pages_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling ExportTemplateVM., must be bigger than or equal to 0.');
        }
