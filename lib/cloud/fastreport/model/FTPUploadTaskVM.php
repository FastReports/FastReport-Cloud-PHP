...
/**
 * FTPUploadTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FTPUploadTaskVM extends TransportTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FTPUploadTaskVM';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ftp_host']) && (mb_strlen($this->container['ftp_host']) > 300)) {
            $invalidProperties[] = "invalid value for 'ftp_host', the character length must be smaller than or equal to 300.";
        }
    ...
    public function setFtpHost($ftp_host)
    {
        ...
        if (!is_null($ftp_host) && (mb_strlen($ftp_host) > 300)) {
            throw new \InvalidArgumentException('invalid length for $ftp_host when calling FTPUploadTaskVM., must be smaller than or equal to 300.');
        }
        if (!is_null($ftp_host) && (mb_strlen($ftp_host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_host when calling FTPUploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setFtpUsername($ftp_username)
    {
        ...
        if (!is_null($ftp_username) && (mb_strlen($ftp_username) > 300)) {
            throw new \InvalidArgumentException('invalid length for $ftp_username when calling FTPUploadTaskVM., must be smaller than or equal to 300.');
        }
        if (!is_null($ftp_username) && (mb_strlen($ftp_username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_username when calling FTPUploadTaskVM., must be bigger than or equal to 1.');
        }
