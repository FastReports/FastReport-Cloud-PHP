...
/**
 * FileCreateFormVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FileCreateFormVM extends CloudBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileCreateFormVM';
    ...
    */
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 3)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling FileCreateFormVM., number of items must be less than or equal to 3.');
        }
     ...
     * Sets icon
     *
     * @param \SplFileObject|null $icon icon
     *
     * @return self
     */
     ...
     * Sets file_content
     *
     * @param \SplFileObject $file_content file_content
     *
     * @return self
     */
