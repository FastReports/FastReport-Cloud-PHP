 ...
 */
class FileCreateVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setContent($content)
    {
        ...
        if (!is_null($content) && (mb_strlen($content) > 1073741824)) {
            throw new \InvalidArgumentException('invalid length for $content when calling FileCreateVM., must be smaller than or equal to 1073741824.');
        }
