...
/**
 * FileUpdateVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FileUpdateVM extends CloudBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileUpdateVM';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['parent_id']) && !preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", $this->container['parent_id'])) {
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FileUpdateVM., must be smaller than or equal to 250.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FileUpdateVM., must be bigger than or equal to 0.');
        }
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", ObjectSerializer::toString($parent_id)))) {
            throw new \InvalidArgumentException("invalid value for \$parent_id when calling FileUpdateVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 3)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling FileUpdateVM., number of items must be less than or equal to 3.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if (!is_null($icon) && (mb_strlen($icon) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling FileUpdateVM., must be smaller than or equal to 65536.');
        }
