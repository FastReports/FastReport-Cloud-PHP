...
/**
 * FolderCreateVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FolderCreateVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FolderCreateVM';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FolderCreateVM., must be smaller than or equal to 250.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FolderCreateVM., must be bigger than or equal to 1.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 3)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling FolderCreateVM., number of items must be less than or equal to 3.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if (!is_null($icon) && (mb_strlen($icon) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling FolderCreateVM., must be smaller than or equal to 65536.');
        }
