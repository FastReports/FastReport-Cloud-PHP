...
/**
 * PrepareTemplateTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PrepareTemplateTaskVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrepareTemplateTaskVM';
    ...
    protected static $openAPITypes = [
        'exports' => '\OpenAPI\Client\cloud\fastreport\model\ExportReportTaskVM[]',
        'pages_count' => 'int',
    ...
    {
        $this->container['exports'] = $data['exports'] ?? null;
     ...
     * Gets exports
     *
     * @return \OpenAPI\Client\cloud\fastreport\model\ExportReportTaskVM[]|null
     */
     ...
     * Sets exports
     *
     * @param \OpenAPI\Client\cloud\fastreport\model\ExportReportTaskVM[]|null $exports exports
     *
     * @return self
     */
    ...
    public function setPagesCount($pages_count)
    {
        ...
        if (!is_null($pages_count) && ($pages_count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling PrepareTemplateTaskVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($pages_count) && ($pages_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling PrepareTemplateTaskVM., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PrepareTemplateTaskVM., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PrepareTemplateTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        ...
        if (!is_null($subscription_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling PrepareTemplateTaskVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
