...
/**
 * ReportCreateAdminVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReportCreateAdminVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportCreateAdminVM';
    ...
    public function setOwnerId($owner_id)
    {
        ...
        if ((!preg_match("/(^[0-9a-f]{24}$|^([0-9a-f]{8}([-][0-9a-f]{4}){3}[-][0-9a-f]{12})$)/", $owner_id))) {
            throw new \InvalidArgumentException("invalid value for $owner_id when calling ReportCreateAdminVM., must conform to the pattern /(^[0-9a-f]{24}$|^([0-9a-f]{8}([-][0-9a-f]{4}){3}[-][0-9a-f]{12})$)/.");
        }
    ...
    public function setParentId($parent_id)
    {
        ...
        if ((!preg_match("/^[A-Fa-f0-9]{24}$/", $parent_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_id when calling ReportCreateAdminVM., must conform to the pattern /^[A-Fa-f0-9]{24}$/.");
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReportCreateAdminVM., must be smaller than or equal to 250.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReportCreateAdminVM., must be bigger than or equal to 0.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 3)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling ReportCreateAdminVM., number of items must be less than or equal to 3.');
        }
    ...
    public function setIcon($icon)
    {
        if (!is_null($icon) && (mb_strlen($icon) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling ReportCreateAdminVM., must be smaller than or equal to 65536.');
        }
    ...
    public function setContent($content)
    {
        if (!is_null($content) && (mb_strlen($content) > 1073741824)) {
            throw new \InvalidArgumentException('invalid length for $content when calling ReportCreateAdminVM., must be smaller than or equal to 1073741824.');
        }
