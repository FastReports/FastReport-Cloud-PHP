...
class ReportInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['creator_version'] = $data['creator_version'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['modified'] = $data['modified'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['picture'] = $data['picture'] ?? null;
        $this->container['preview_picture_ratio'] = $data['preview_picture_ratio'] ?? null;
        $this->container['save_mode'] = $data['save_mode'] ?? null;
        $this->container['save_preview_picture'] = $data['save_preview_picture'] ?? null;
