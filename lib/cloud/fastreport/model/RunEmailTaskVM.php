 ...
 */
class RunEmailTaskVM extends RunTransportTaskBaseVM
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['to']) > 200)) {
    ...
    public function setTo($to)
    {
        ...
        if ((count($to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to when calling RunEmailTaskVM., number of items must be greater than or equal to 1.');
        }
