 ...
 */
class RunInputFileVM extends InputFileVM
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['content']) && (mb_strlen($this->container['content']) > 10000000)) {
            $invalidProperties[] = "invalid value for 'content', the character length must be smaller than or equal to 10000000.";
        }
    ...
    public function setContent($content)
    {
        ...
        if (!is_null($content) && (mb_strlen($content) > 10000000)) {
            throw new \InvalidArgumentException('invalid length for $content when calling RunInputFileVM., must be smaller than or equal to 10000000.');
        }
