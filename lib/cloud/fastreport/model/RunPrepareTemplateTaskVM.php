...
/**
 * RunPrepareTemplateTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RunPrepareTemplateTaskVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RunPrepareTemplateTaskVM';
    ...
    protected static $openAPITypes = [
        'exports' => '\OpenAPI\Client\cloud\fastreport\model\RunExportReportTaskVM[]',
        'pages_count' => 'int',
     ...
     * Gets exports
     *
     * @return \OpenAPI\Client\cloud\fastreport\model\RunExportReportTaskVM[]|null
     */
     ...
     * Sets exports
     *
     * @param \OpenAPI\Client\cloud\fastreport\model\RunExportReportTaskVM[]|null $exports exports
     *
     * @return self
     */
    public function setExports($exports)
    {
        ...
        if (!is_null($exports) && (count($exports) > 10)) {
            throw new \InvalidArgumentException('invalid value for $exports when calling RunPrepareTemplateTaskVM., number of items must be less than or equal to 10.');
        }
    ...
    public function setPagesCount($pages_count)
    {
        ...
        if (!is_null($pages_count) && ($pages_count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling RunPrepareTemplateTaskVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($pages_count) && ($pages_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling RunPrepareTemplateTaskVM., must be bigger than or equal to 0.');
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        ...
        if (!is_null($subscription_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling RunPrepareTemplateTaskVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
