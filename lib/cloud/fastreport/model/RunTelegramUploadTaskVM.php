...
/**
 * RunTelegramUploadTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RunTelegramUploadTaskVM extends RunTransportTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RunTelegramUploadTaskVM';
    ...
    */
    ...
    public function setBotToken($bot_token)
    {
        ...
        if (!is_null($bot_token) && (mb_strlen($bot_token) > 400)) {
            throw new \InvalidArgumentException('invalid length for $bot_token when calling RunTelegramUploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($bot_token) && (mb_strlen($bot_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bot_token when calling RunTelegramUploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setContacts($contacts)
    {
        ...
        if (!is_null($contacts) && (count($contacts) > 200)) {
            throw new \InvalidArgumentException('invalid value for $contacts when calling RunTelegramUploadTaskVM., number of items must be less than or equal to 200.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 384000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling RunTelegramUploadTaskVM., must be smaller than or equal to 384000.');
        }
        if (!is_null($text) && (mb_strlen($text) < 0)) {
            throw new \InvalidArgumentException('invalid length for $text when calling RunTelegramUploadTaskVM., must be bigger than or equal to 0.');
        }
