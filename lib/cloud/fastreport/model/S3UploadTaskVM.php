...
/**
 * S3UploadTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class S3UploadTaskVM extends TransportTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'S3UploadTaskVM';
    ...
    */
    ...
    public function setAccessKey($access_key)
    {
        ...
        if (!is_null($access_key) && (mb_strlen($access_key) > 400)) {
            throw new \InvalidArgumentException('invalid length for $access_key when calling S3UploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($access_key) && (mb_strlen($access_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $access_key when calling S3UploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setBucketName($bucket_name)
    {
        ...
        if (!is_null($bucket_name) && (mb_strlen($bucket_name) > 400)) {
            throw new \InvalidArgumentException('invalid length for $bucket_name when calling S3UploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($bucket_name) && (mb_strlen($bucket_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bucket_name when calling S3UploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setDestinationFolder($destination_folder)
    {
        ...
        if (!is_null($destination_folder) && (mb_strlen($destination_folder) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $destination_folder when calling S3UploadTaskVM., must be smaller than or equal to 5000.');
        }
        if (!is_null($destination_folder) && (mb_strlen($destination_folder) < 0)) {
            throw new \InvalidArgumentException('invalid length for $destination_folder when calling S3UploadTaskVM., must be bigger than or equal to 0.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 20)) {
            throw new \InvalidArgumentException('invalid length for $region when calling S3UploadTaskVM., must be smaller than or equal to 20.');
        }
        if (!is_null($region) && (mb_strlen($region) < 0)) {
            throw new \InvalidArgumentException('invalid length for $region when calling S3UploadTaskVM., must be bigger than or equal to 0.');
        }
