...
/**
 * SubscriptionPlansVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionPlansVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionPlansVM';
    ...
    protected static $openAPITypes = [
        'subscription_plans' => '\OpenAPI\Client\cloud\fastreport\model\SubscriptionPlanVM[]',
        'count' => 'int',
        'skip' => 'int',
        'take' => 'int'
    ];
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\cloud\fastreport\model\SubscriptionPlanVM[]|null $subscription_plans subscription_plans
     *
     * @return self
     */
    public function setSubscriptionPlans($subscription_plans)
    {
        if (is_null($subscription_plans)) {
            array_push($this->openAPINullablesSetToNull, 'subscription_plans');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('subscription_plans', $nullablesSetToNull);
            if ($index !== FALSE) {
