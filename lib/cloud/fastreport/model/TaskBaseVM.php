 ...
 */
class TaskBaseVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'delayed_run_time' => 'date-time',
        'delayed_was_run_time' => 'date-time',
        'id' => null,
        'name' => null,
    ...
    protected static array $openAPINullables = [
		...
		'delayed_run_time' => true,
		'delayed_was_run_time' => true,
		'id' => true,
		'name' => true,
    ...
    protected static $setters = [
        ...
        'delayed_run_time' => 'setDelayedRunTime',
        'delayed_was_run_time' => 'setDelayedWasRunTime',
        'id' => 'setId',
        'name' => 'setName',
    ...
    protected static $getters = [
        ...
        'delayed_run_time' => 'getDelayedRunTime',
        'delayed_was_run_time' => 'getDelayedWasRunTime',
        'id' => 'getId',
        'name' => 'getName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('delayed_run_time', $data ?? [], null);
        $this->setIfExists('delayed_was_run_time', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets delayed_run_time
     *
     * @return \DateTime|null
     */
    public function getDelayedRunTime()
    {
        return $this->container['delayed_run_time'];
    }

    /**
     * Sets delayed_run_time
     *
     * @param \DateTime|null $delayed_run_time delayed_run_time
     *
     * @return self
     */
    public function setDelayedRunTime($delayed_run_time)
    {
        if (is_null($delayed_run_time)) {
            array_push($this->openAPINullablesSetToNull, 'delayed_run_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delayed_run_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['delayed_run_time'] = $delayed_run_time;

        return $this;
    }

    /**
     * Gets delayed_was_run_time
     *
     * @return \DateTime|null
     */
    public function getDelayedWasRunTime()
    {
        return $this->container['delayed_was_run_time'];
    }

    /**
     * Sets delayed_was_run_time
     *
     * @param \DateTime|null $delayed_was_run_time delayed_was_run_time
     *
     * @return self
     */
    public function setDelayedWasRunTime($delayed_was_run_time)
    {
        if (is_null($delayed_was_run_time)) {
            array_push($this->openAPINullablesSetToNull, 'delayed_was_run_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delayed_was_run_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['delayed_was_run_time'] = $delayed_was_run_time;
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[A-Fa-f0-9]{24}$/", $id))) {
