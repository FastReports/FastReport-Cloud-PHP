...
/**
 * TelegramUploadTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TelegramUploadTaskVM extends TransportTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TelegramUploadTaskVM';
    ...
    */
    ...
    public function setContacts($contacts)
    {
        ...
        if (!is_null($contacts) && (count($contacts) > 200)) {
            throw new \InvalidArgumentException('invalid value for $contacts when calling TelegramUploadTaskVM., number of items must be less than or equal to 200.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 384000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling TelegramUploadTaskVM., must be smaller than or equal to 384000.');
        }
        if (!is_null($text) && (mb_strlen($text) < 0)) {
            throw new \InvalidArgumentException('invalid length for $text when calling TelegramUploadTaskVM., must be bigger than or equal to 0.');
        }
