...
class TemplateCreateAdminVM extends TemplateCreateVM
{
    ...
    */
    ...
    public function setOwnerId($owner_id)
    {
        ...
        if ((!preg_match("/(^[0-9a-f]{24}$|^([0-9a-f]{8}([-][0-9a-f]{4}){3}[-][0-9a-f]{12})$)/", ObjectSerializer::toString($owner_id)))) {
    ...
    public function setParentId($parent_id)
    {
        ...
        if ((!preg_match("/^[A-Fa-f0-9]{24}$/", ObjectSerializer::toString($parent_id)))) {
