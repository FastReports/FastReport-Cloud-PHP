...
/**
 * TemplateCreateVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TemplateCreateVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateCreateVM';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TemplateCreateVM., must be smaller than or equal to 250.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TemplateCreateVM., must be bigger than or equal to 0.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (count($tags) > 3)) {
            throw new \InvalidArgumentException('invalid value for $tags when calling TemplateCreateVM., number of items must be less than or equal to 3.');
        }
    ...
    public function setIcon($icon)
    {
        if (!is_null($icon) && (mb_strlen($icon) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling TemplateCreateVM., must be smaller than or equal to 65536.');
        }
    ...
    public function setContent($content)
    {
        if (!is_null($content) && (mb_strlen($content) > 1073741824)) {
            throw new \InvalidArgumentException('invalid length for $content when calling TemplateCreateVM., must be smaller than or equal to 1073741824.');
        }
