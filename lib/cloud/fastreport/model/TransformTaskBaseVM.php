...
/**
 * TransformTaskBaseVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransformTaskBaseVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransformTaskBaseVM';
    ...
    protected static $openAPITypes = [
        ...
        'transports' => '\OpenAPI\Client\cloud\fastreport\model\TransportTaskBaseVM[]',
        'name' => 'string',
    ...
    public function setLocale($locale)
    {
        ...
        if (!is_null($locale) && (!preg_match("/^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/", $locale))) {
            throw new \InvalidArgumentException("invalid value for $locale when calling TransformTaskBaseVM., must conform to the pattern /^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/.");
        }
     ...
     * Gets transports
     *
     * @return \OpenAPI\Client\cloud\fastreport\model\TransportTaskBaseVM[]|null
     */
     ...
     * Sets transports
     *
     * @param \OpenAPI\Client\cloud\fastreport\model\TransportTaskBaseVM[]|null $transports transports
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TransformTaskBaseVM., must be smaller than or equal to 50.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TransformTaskBaseVM., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        ...
        if (!is_null($subscription_id) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling TransformTaskBaseVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
