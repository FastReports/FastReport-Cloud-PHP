...
/**
 * UpdateDataSourceConnectionStringVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDataSourceConnectionStringVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDataSourceConnectionStringVM';
    ...
    public function setConnectionString($connection_string)
    {
        if ((mb_strlen($connection_string) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $connection_string when calling UpdateDataSourceConnectionStringVM., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($connection_string) < 0)) {
            throw new \InvalidArgumentException('invalid length for $connection_string when calling UpdateDataSourceConnectionStringVM., must be bigger than or equal to 0.');
        }
