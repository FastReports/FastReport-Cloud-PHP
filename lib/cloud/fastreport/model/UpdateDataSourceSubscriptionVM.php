...
/**
 * UpdateDataSourceSubscriptionVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDataSourceSubscriptionVM extends CloudBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDataSourceSubscriptionVM';
    ...
    */
    ...
    public function setSubscriptionId($subscription_id)
    {
        ...
        if ((mb_strlen($subscription_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling UpdateDataSourceSubscriptionVM., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Fa-f0-9]{24}$/", ObjectSerializer::toString($subscription_id)))) {
            throw new \InvalidArgumentException("invalid value for \$subscription_id when calling UpdateDataSourceSubscriptionVM., must conform to the pattern /^[A-Fa-f0-9]{24}$/.");
        }
