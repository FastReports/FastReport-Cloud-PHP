...
/**
 * UpdateExportReportTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateExportReportTaskVM extends UpdateTransformTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateExportReportTaskVM';
    ...
    */
     ...
     * Sets format
     *
     * @param ExportFormat|null $format format
     *
     * @return self
     */
    ...
    public function setPagesCount($pages_count)
    {
        ...
        if (!is_null($pages_count) && ($pages_count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling UpdateExportReportTaskVM., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($pages_count) && ($pages_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $pages_count when calling UpdateExportReportTaskVM., must be bigger than or equal to 0.');
        }
