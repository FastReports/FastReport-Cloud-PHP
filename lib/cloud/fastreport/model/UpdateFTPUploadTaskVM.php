...
/**
 * UpdateFTPUploadTaskVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateFTPUploadTaskVM extends UpdateTransportTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateFTPUploadTaskVM';
    ...
    */
    ...
    public function setFtpHost($ftp_host)
    {
        ...
        if (!is_null($ftp_host) && (mb_strlen($ftp_host) > 400)) {
            throw new \InvalidArgumentException('invalid length for $ftp_host when calling UpdateFTPUploadTaskVM., must be smaller than or equal to 400.');
        }
        if (!is_null($ftp_host) && (mb_strlen($ftp_host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_host when calling UpdateFTPUploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    public function setFtpPassword($ftp_password)
    {
        ...
        if (!is_null($ftp_password) && (mb_strlen($ftp_password) > 300)) {
            throw new \InvalidArgumentException('invalid length for $ftp_password when calling UpdateFTPUploadTaskVM., must be smaller than or equal to 300.');
        }
        if (!is_null($ftp_password) && (mb_strlen($ftp_password) < 4)) {
            throw new \InvalidArgumentException('invalid length for $ftp_password when calling UpdateFTPUploadTaskVM., must be bigger than or equal to 4.');
        }
    ...
    {
        if (is_null($ftp_port)) {
            array_push($this->openAPINullablesSetToNull, 'ftp_port');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ftp_port', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setFtpUsername($ftp_username)
    {
        ...
        if (!is_null($ftp_username) && (mb_strlen($ftp_username) > 300)) {
            throw new \InvalidArgumentException('invalid length for $ftp_username when calling UpdateFTPUploadTaskVM., must be smaller than or equal to 300.');
        }
        if (!is_null($ftp_username) && (mb_strlen($ftp_username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ftp_username when calling UpdateFTPUploadTaskVM., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($use_sftp)) {
            array_push($this->openAPINullablesSetToNull, 'use_sftp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('use_sftp', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
