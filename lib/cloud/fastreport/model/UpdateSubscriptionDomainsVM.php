...
/**
 * UpdateSubscriptionDomainsVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSubscriptionDomainsVM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSubscriptionDomainsVM';
    ...
    */
    ...
    public function setDomains($domains)
    {
        ...
        if (!is_null($domains) && (count($domains) > 10)) {
            throw new \InvalidArgumentException('invalid value for $domains when calling UpdateSubscriptionDomainsVM., number of items must be less than or equal to 10.');
        }
