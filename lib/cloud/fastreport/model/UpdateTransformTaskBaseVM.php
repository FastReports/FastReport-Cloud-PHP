...
/**
 * UpdateTransformTaskBaseVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTransformTaskBaseVM extends UpdateTaskBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTransformTaskBaseVM';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transport_ids', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['transport_ids']) && (count($this->container['transport_ids']) > 10)) {
            $invalidProperties[] = "invalid value for 'transport_ids', number of items must be less than or equal to 10.";
        }
    ...
    public function setLocale($locale)
    {
        ...
        if (!is_null($locale) && (!preg_match("/^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/", $locale))) {
            throw new \InvalidArgumentException("invalid value for \$locale when calling UpdateTransformTaskBaseVM., must conform to the pattern /^[a-zA-Z]{2,4}(-[a-zA-Z]{2,4}){0,2}$/.");
        }
    ...
    {
        return $this->container['transport_ids'];
    }

    /**
     * Sets transport_ids
     *
     * @param string[]|null $transport_ids transport_ids
     *
     * @return self
     */
    public function setTransportIds($transport_ids)
    {
        if (is_null($transport_ids)) {
            array_push($this->openAPINullablesSetToNull, 'transport_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transport_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($transport_ids) && (count($transport_ids) > 10)) {
            throw new \InvalidArgumentException('invalid value for $transport_ids when calling UpdateTransformTaskBaseVM., number of items must be less than or equal to 10.');
        }
        $this->container['transport_ids'] = $transport_ids;
