...
/**
 * UpdateUserSettingsVM Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateUserSettingsVM extends CloudBaseVM
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateUserSettingsVM';
    ...
    */
    ...
    public function setProfileVisibility($profile_visibility)
    {
        if (is_null($profile_visibility)) {
            array_push($this->openAPINullablesSetToNull, 'profile_visibility');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('profile_visibility', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setDefaultSubscription($default_subscription)
    {
        ...
        if (!is_null($default_subscription) && (!preg_match("/(^$)|(^[A-Fa-f0-9]{24}$)/", ObjectSerializer::toString($default_subscription)))) {
            throw new \InvalidArgumentException("invalid value for \$default_subscription when calling UpdateUserSettingsVM., must conform to the pattern /(^$)|(^[A-Fa-f0-9]{24}$)/.");
        }
    ...
    public function setShowHiddenFilesAndFolders($show_hidden_files_and_folders)
    {
        if (is_null($show_hidden_files_and_folders)) {
            array_push($this->openAPINullablesSetToNull, 'show_hidden_files_and_folders');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('show_hidden_files_and_folders', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
